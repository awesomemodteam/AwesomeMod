...
namespace VRCLoader.Utils
{
    public static class MinHook
    {
        ...
        public static void CreateInstance(IntPtr mGetLicense, IntPtr mVRC_CreateHook, IntPtr mVRC_RemoveHook, IntPtr mVRC_EnableHook, IntPtr mVRC_DisableHook)
        {
            GetLicense = CreateDelegate<_GetLicense>(mGetLicense);
