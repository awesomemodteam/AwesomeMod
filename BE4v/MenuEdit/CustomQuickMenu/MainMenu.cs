...
namespace CustomQuickMenu.Menus
{
    public static class MainMenu
    {
        ...
        public static void BlazeEngine4VersionMenu()
        {
            ...
            {
                registerMenu.AddHeader("Awesome Toggles");
                buttonsGroup = registerMenu.AddButtonsGroup("AwesomeToggles");
            }
            ...
            {
                Serilize.button = buttonsGroup.AddButton("Sterilize\n<color=red>Homosexual</color>", Serilize.OnClick);
                Serilize.Refresh();
            }
