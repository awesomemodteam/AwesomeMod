...
namespace CustomQuickMenu.Menus
{
    public static class BE4VMenu
    {
        ...
        public static void BlazeEngine4VersionMenu()
        {
            try
            {
                registerMenu = MenuElement.Create("Awesome Menu");
            }
            catch { "Register menu is error".RedPrefix("Error!"); }

            horizontalButton = new ElementHorizontalButton("Awesome Menu", delegate () { registerMenu.Open(); }, "Awesome Menu", sprite: LoadSprites.be4vLogo);
            ...
            registerMenu.AddHeader("Moar Stuff");
            butttonsGroup = registerMenu.AddButtonsGroup("Moar Stuff");
        ...
        public static class FlyType
        {
            ...
            public static void Refresh()
            {
                if (button != null)
                {
                    ...
                    {
                        button._Text = "<color=red>Standard</color>\nFly Type:";
                    }
                }
            }
        }
