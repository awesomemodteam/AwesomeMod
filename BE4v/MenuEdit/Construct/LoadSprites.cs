    ...
    public static class LoadSprites
    {
        ...
        public static Sprite be4vLogo
        {
            get
            {
                ...
                {
                    be4vLogoSprite = Utils.Sprites.DownloadSprite("http://domkrats.nyx.feralhosting.com/smiley.png", 64, 64);
                }
        ...
        public static Sprite onButton
        {
            get
            {
                ...
                {
                    onButtonSprite = Utils.Sprites.DownloadSprite("http://domkrats.nyx.feralhosting.com/on.png", 64, 64);
                }
        ...
        public static Sprite offButton
        {
            get
            {
                ...
                {
                    offButtonSprite = Utils.Sprites.DownloadSprite("http://domkrats.nyx.feralhosting.com/off.png", 64, 64);
                }
        ...
        public static Sprite trashIco
        {
            get
            {
                ...
                {
                    trashIcoSprite = Utils.Sprites.DownloadSprite("http://domkrats.nyx.feralhosting.com/trash.png", 64, 64);
                }
        ...
        public static Sprite notifyIco
        {
            get
            {
                ...
                {
                    notifyIcoSprite = Utils.Sprites.DownloadSprite("http://domkrats.nyx.feralhosting.com/notify.png", 64, 64);
                }
        ...
        public static Sprite sitonIco
        {
            get
            {
                ...
                {
                    sitonIcoSprite = Utils.Sprites.DownloadSprite("http://domkrats.nyx.feralhosting.com/siton.png", 64, 64);
                }
        ...
        public static Sprite gamingIco
        {
            get
            {
                ...
                {
                    gamingIcoSprite = Utils.Sprites.DownloadSprite("http://domkrats.nyx.feralhosting.com/smiley.png", 64, 64);
                }
        ...
        public static Sprite flyTypeIco
        {
            get
            {
                ...
                {
                    flyTypeIcoSprite = Utils.Sprites.DownloadSprite("http://domkrats.nyx.feralhosting.com/fly.png", 64, 64);
                }
        ...
        public static Sprite pickupOrbitIco
        {
            get
            {
                ...
                {
                    pickupOrbitIcoSprite = Utils.Sprites.DownloadSprite("http://domkrats.nyx.feralhosting.com/magic.png", 64, 64);
                }
